...
export function PlayScreen() {
  ...
  const [config, setConfig] = useState<X01Config>(X01_DEFAULT_CONFIG);
        ...
        <div className="mt-4 grid grid-cols-1 gap-3 sm:grid-cols-2">
          <label className="text-sm">
            ...
            <select
              ...
              onChange={(e) =>
                setConfig((c) => ({ ...c, startScore: Number(e.target.value) as X01StartScore }))
              }
          ...
          <label className="text-sm">
            ...
            <select
              ...
              value={config.inRule}
              onChange={(e) =>
                setConfig((c) => ({ ...c, inRule: e.target.value as X01InRule }))
              }
          ...
          <label className="text-sm">
            ...
            <select
              ...
              onChange={(e) =>
                setConfig((c) => ({ ...c, outRule: e.target.value as X01OutRule }))
              }
